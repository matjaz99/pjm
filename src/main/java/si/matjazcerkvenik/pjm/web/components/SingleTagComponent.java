 ...
 */
package si.matjazcerkvenik.pjm.web.components;
...
public class SingleTagComponent extends UIComponentBase {
	...
	public void encodeBegin(FacesContext ctx) throws IOException {
		...
		String color = (String) getAttributes().get("color");

		String textColor = "black";
		
		rw.startElement("div", this);
		rw.writeAttribute("class", "tagBorder", null);
		rw.writeAttribute("style", "background-color: " + color + "; color: " + textColor + ";", null);
		//rw.write(t.getName());
		//rw.endElement("div");
