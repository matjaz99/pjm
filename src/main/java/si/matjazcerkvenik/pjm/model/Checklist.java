...
public class Checklist implements Serializable {
    ...
    public static final String ITEM_NPI_OPENED = "NPI opened";
    public static final String ITEM_RD_PROJECT_OPENED = "R&D project opened";
    public static final String ITEM_REQUIREMENTS_DEFINED = "Requirements defined";
